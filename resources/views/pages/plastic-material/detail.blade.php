        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ol>
                    ...
                    <li><a href="/category-materials/{{ $material->materialCategory->slug }}">{{ $material->materialCategory->name }}</a></li>
                    <li>{{ $material->name }}</li>
                </ol>
            </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="zoom-in-up" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <div class="portfolio-details-slider swiper">
                        <div class="swiper-wrapper align-items-center">
                            @forelse ($materialGalleries as $gallery)
                                <div class="swiper-slide">
                                    <img src="{{ $gallery->photo}}" alt="Gallery Material">
                                </div>
                            @empty
                ...
                <div class="col-lg-8 col-md-6 col-sm-12">
                    <div class="portfolio-info" data-aos="zoom-in-up" data-aos-offset="300" data-aos-easing="ease-in-sine">
                        ...
                        <p>{!! nl2br(e($material->short_description)) !!}
                    </div>
                </div>
                        ...
                        <div class="blog">
                            <div class="div">
                                ...
                                @else
                                    <img src="/img/no-picture-taking.png" alt="Default Image" class="lozad text-center mb-4" />
                                @endisset
                                <h4 class="text-center"><a href="{{ route('plastic-material', $items->slug) }}">{{ $items->name }}</a></h4>
                                @php
